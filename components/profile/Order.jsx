...
const Order = () => {
  ...
  return (
    <div className="lg:p-8 flex-1 lg:mt-0 mt-5">
      <Title addClass="text-[40px]">আমার অর্ডার</Title>
          ...
          <tbody>
            {orders.map((order) => (
              ...
              >
                ...
                <td className="py-4 px-6 font-medium whitespace-nowrap hover:text-white">
                  {(order.status === 0 && "খাবার প্রস্তুত হচ্ছে") ||
                    (order.status === 1 && "রাইডার খাবার নিয়ে রওনা দিয়েছেন") ||
                    (order.status === 2 && "আপনার অর্ডার পৌঁছে গেছে")}
                </td>
              </tr>
            ))}
          </tbody>
