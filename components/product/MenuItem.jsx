  ...
  return (
    <div className="bg-secondary rounded-3xl relative">
      ...
      <div className="p-[25px] text-white ">
        <h4 className="text-xl font-semibold mb-3 leading-snug">{product.title}</h4>
        <p className="text-[15px] leading-relaxed text-gray-300">{product.desc}</p>
        <div className="flex justify-between items-center mt-4">
          <span className="font-semibold text-primary">৳{product.prices[0]}</span>
          <button
