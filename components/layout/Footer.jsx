      ...
      <div className="container mx-auto pt-16 pb-6">
        <div className="flex md:justify-between justify-center text-center flex-wrap md:gap-y-0 gap-y-6 ">
          <div className="md:flex-1">
            <Title addClass="text-[30px]">যোগাযোগ করুন</Title>
            <div className="flex flex-col gap-y-2 mt-3">
              <a href={footer?.location} target="_blank" rel="noreferrer">
                <i className="fa fa-map-marker"></i>
                <span className="inline-block ml-2">অবস্থান</span>
              </a>
              <div>
          ...
          <div className="md:flex-1">
            <Title addClass="text-[38px]">খাই চাটগাঁ</Title>
            <p className="mt-3">
              {footer?.desc
                ? footer.desc
                : "চাটগাঁর সেরা রেস্টুরেন্ট থেকে আপনার পছন্দের খাবার পৌঁছে দিচ্ছি আপনার দোরগোড়ায়।"}
            </p>
          ...
          <div className="md:flex-1">
            <Title addClass="text-[30px]">খোলার সময়</Title>
            <div className="flex flex-col gap-y-2 mt-3">
              <div>
        ...
        <p className="text-center mt-10">
          © ২০২৬ খাই চাটগাঁ। সর্বস্বত্ব সংরক্ষিত।
        </p>
      </div>
    </div>
  );
