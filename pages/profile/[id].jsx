      ...
      <div className="lg:w-80 w-100 flex-shrink-0 lg:h-[80vh]   justify-center flex flex-col border-l-2 border-r-4 shadow-2xl">
        ...
        <ul className="text-center font-semibold">
          ...
          >
            ...
            <button className="ml-1 ">অ্যাকাউন্ট</button>
          </li>
          <li
            className={`border w-full p-3 cursor-pointer hover:bg-primary hover:text-white transition-all ${
          ...
          >
            ...
            <button className="ml-1">পাসওয়ার্ড</button>
          </li>
          <li
            className={`border w-full p-3 cursor-pointer hover:bg-primary hover:text-white transition-all ${
          ...
          >
            ...
            <button className="ml-1">আমার অর্ডার</button>
          </li>
          <li
            className={`border w-full p-3 cursor-pointer hover:bg-primary hover:text-white transition-all`}
          ...
          >
            ...
            <button className="ml-1">লগআউট</button>
          </li>
        </ul>
      </div>
